...
def FetchLatestFile():
    ...
    directory = st.secrets["DIRECTORY_RELATIVE_PATH_FEATURE"]
...
def streamlitMain(file,FilterContinents,FilterCountries,FilterCategory,FilterYears,FilterChannelNames,FilterLicensedContent):
    ...
    st.markdown(
        ...
        <div style="display: flex; align-items: center;">
            ...
            <h1 style="margin: 0; font-size: 35px"> &nbsp; YouTube Trend Analysis: A Data-Driven Deep Dive into DevOps Content</h1>
        </div>
        """,
        unsafe_allow_html=True
    )
